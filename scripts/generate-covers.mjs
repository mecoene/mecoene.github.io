...
function makeBalkan() {
  ...
  for (let f = 0; f < frames; f += 1) {
    const c = new Canvas(1);
    for (let x = 34; x < 252; x += 18) c.line(x, 28, x, 154, 3, 1);
    for (let y = 32; y < 156; y += 18) c.line(32, y, 252, y, 3, 1);
    c.line(36, 150, 252, 150, 8, 2);
    c.line(36, 150, 36, 28, 8, 2);
    ...
    c.line(118, 142, 246, 48 + Math.sin(f * 0.24) * 5, 15, 1);
    border(c, 50);
    data.push(c.pixels);
  }
  return data;
